...
class BaseWindow:
    def __init__(self, title, master=None):
        ...
        style.configure("TLabel", font=("Runic", 12))
        style.configure("TButton", font=("Runic", 12))
        style.configure("TEntry", font=("Runic", 12))
        self.setup_window(title)
        self.frame = tk.Frame(self.root, background="#002b39")
...
class MainMenu(BaseWindow):
    def __init__(self, stock_items):
        super().__init__("Requisition Logger")
        self.stock_items = stock_items
